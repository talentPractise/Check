...
async def test_get_provider_info_when_multiple_record_with_highest_scores(
    ...
    # Scenario 1: Multiple records with highest PROVIDER_BUSINESS_GROUP_SCORE_NBR
    ...
    # Scenario 2: Some records have PROVIDER_BUSINESS_GROUP_SCORE_NBR as None
    mock_client.execute_query.return_value = [
        {
            "PROVIDER_BUSINESS_GROUP_NBR": "PBG001",
    ...
    # Scenario 3:  All records have PROVIDER_BUSINESS_GROUP_SCORE_NBR as None
    mock_client.execute_query.return_value = [
        {
            "PROVIDER_BUSINESS_GROUP_NBR": "PBG001",
            "PROVIDER_BUSINESS_GROUP_SCORE_NBR": None,
